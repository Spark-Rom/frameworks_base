...
package com.android.server.spark.globalactions;
...
import static com.android.internal.util.spark.globalactions.PowerMenuConstants.GLOBAL_ACTION_KEY_BUGREPORT;
import static com.android.internal.util.spark.globalactions.PowerMenuConstants.GLOBAL_ACTION_KEY_LOCKDOWN;
...
import com.android.internal.util.spark.globalactions.ISparkGlobalActions;
 ...
 * @hide
 */
public class SparkGlobalActionsService extends SystemService {
    ...
    public SparkGlobalActionsService(Context context) {
        super(context);
    ...
    @Override
    public void onStart() {
        publishBinderService(ContextConstants.SPARK_GLOBAL_ACTIONS_SERVICE, mBinder);
    }
    ...
    private final IBinder mBinder = new ISparkGlobalActions.Stub() {
