...
public class SparkUtils {
   ...
   public static void showSettingsRestartDialog(Context context) {
    ...
    public static class SparkController {
        ...
        private boolean mSparkAggresiveMode;
        private boolean mSparkBasicMode;
        ...
        public SparkController(Context context) {
            mContext = context;
            ...
            mSparkBasicMode = Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.SPARK_SYSTEM_MANAGER, 0, UserHandle.USER_CURRENT) == 1;

            mSparkAggresiveMode = Settings.Secure.getIntForUser(mContext.getContentResolver(),
                    Settings.Secure.SPARK_AGGRESSIVE_IDLE_MODE, 0, UserHandle.USER_CURRENT) == 1;
        ...
        private void enableAggressiveMode() {
            ...
            // Disable Wi-Fi
            final boolean sparkDisableWifi = Settings.Secure.getIntForUser(mContext.getContentResolver(),
                    Settings.Secure.SPARK_AGGRESSIVE_IDLE_MODE_WIFI_TOGGLE, 0, UserHandle.USER_CURRENT) == 1;
            if (sparkDisableWifi) {
            ...
            // Disable Bluetooth
            final boolean sparkDisableBluetooth = Settings.Secure.getIntForUser(mContext.getContentResolver(),
                    Settings.Secure.SPARK_AGGRESSIVE_IDLE_MODE_BLUETOOTH_TOGGLE, 0, UserHandle.USER_CURRENT) == 1;
            if (sparkDisableBluetooth) {
                mBluetoothState = isBluetoothEnabled();
                setBluetoothEnabled(false);
            }

            // Disable Mobile Data
            final boolean sparkDisableData = Settings.Secure.getIntForUser(mContext.getContentResolver(),
                    Settings.Secure.SPARK_AGGRESSIVE_IDLE_MODE_CELLULAR_TOGGLE, 0, UserHandle.USER_CURRENT) == 1;
            if (sparkDisableData) {
            ...
            // Disable Location
            final boolean sparkDisableLocation = Settings.Secure.getIntForUser(mContext.getContentResolver(),
                    Settings.Secure.SPARK_AGGRESSIVE_IDLE_MODE_LOCATION_TOGGLE, 0, UserHandle.USER_CURRENT) == 1;
            if (sparkDisableLocation) {
        ...
        private void disableAggressiveMode() {
            ...
            final boolean sparkDisableWifi = Settings.Secure.getIntForUser(mContext.getContentResolver(),
                    Settings.Secure.SPARK_AGGRESSIVE_IDLE_MODE_WIFI_TOGGLE, 0, UserHandle.USER_CURRENT) == 1;
            if (sparkDisableWifi && mWifiState != isWifiEnabled()) {
            ...
            final boolean sparkDisableBluetooth = Settings.Secure.getIntForUser(mContext.getContentResolver(),
                    Settings.Secure.SPARK_AGGRESSIVE_IDLE_MODE_BLUETOOTH_TOGGLE, 0, UserHandle.USER_CURRENT) == 1;
            if (sparkDisableBluetooth && mBluetoothState != isBluetoothEnabled()) {
            ...
            final boolean sparkDisableData = Settings.Secure.getIntForUser(mContext.getContentResolver(),
                    Settings.Secure.SPARK_AGGRESSIVE_IDLE_MODE_CELLULAR_TOGGLE, 0, UserHandle.USER_CURRENT) == 1;
            if (sparkDisableData && mCellularState != getTelephonyManager().isDataEnabled()) {
            ...
            final boolean sparkDisableLocation = Settings.Secure.getIntForUser(mContext.getContentResolver(),
                    Settings.Secure.SPARK_AGGRESSIVE_IDLE_MODE_LOCATION_TOGGLE, 0, UserHandle.USER_CURRENT) == 1;
            if (sparkDisableLocation && mLocationState != getLocationMode()) {
        ...
        private void setAMTriggerState(boolean aggressiveTriggerState) {
            if (mSparkAggresiveMode == aggressiveTriggerState) {
                return;
            }

            mSparkAggresiveMode = aggressiveTriggerState;

            if (mSparkAggresiveMode) {
        ...
        class SettingsObserver extends ContentObserver {
            ...
            void observe() {
                ...
                resolver.registerContentObserver(Settings.Secure.getUriFor(
                        Settings.Secure.SPARK_AGGRESSIVE_IDLE_MODE), false, this,
                        UserHandle.USER_ALL);
                resolver.registerContentObserver(Settings.Secure.getUriFor(
                        Settings.Secure.SPARK_AGGRESSIVE_IDLE_MODE_TRIGGER), false, this,
                        UserHandle.USER_ALL);
            ...
            void update() {
                ...
                final boolean amTriggerState = Settings.Secure.getIntForUser(mContext.getContentResolver(),
                        Settings.Secure.SPARK_AGGRESSIVE_IDLE_MODE_TRIGGER, 0, UserHandle.USER_CURRENT) == 1;
