...
import com.spark.packageinstaller.handheld.ErrorDialogFragment;
import com.spark.packageinstaller.handheld.UninstallAlertDialogFragment;

import java.util.List;

import static android.app.AppOpsManager.MODE_ALLOWED;
import static com.spark.packageinstaller.PackageUtil.getMaxTargetSdkVersionForUid;

/*
 * This activity presents UI to uninstall an application. Usually launched with intent
 * Intent.ACTION_UNINSTALL_PKG_COMMAND and attribute
 * com.spark.packageinstaller.PackageName set to the application package name
 */
