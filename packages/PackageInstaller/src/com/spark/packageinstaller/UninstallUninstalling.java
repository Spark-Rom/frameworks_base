...
public class UninstallUninstalling extends Activity implements
    ...
    static final String EXTRA_APP_LABEL = "com.spark.packageinstaller.extra.APP_LABEL";
    static final String EXTRA_KEEP_DATA = "com.spark.packageinstaller.extra.KEEP_DATA";
    private static final String LOG_TAG = UninstallUninstalling.class.getSimpleName();
    private static final String UNINSTALL_ID = "com.spark.packageinstaller.UNINSTALL_ID";
    private static final String BROADCAST_ACTION =
            "com.spark.packageinstaller.ACTION_UNINSTALL_COMMIT";
