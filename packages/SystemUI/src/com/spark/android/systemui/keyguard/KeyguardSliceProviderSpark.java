package com.spark.android.systemui.keyguard;
...
public class KeyguardSliceProviderSpark extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<KeyguardSliceProviderSpark> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(KeyguardSliceProviderSpark keyguardSliceProviderSpark, SmartSpaceCard smartSpaceCard) {
            mProviderReference = new WeakReference<>(keyguardSliceProviderSpark);
            mWeatherCard = smartSpaceCard;
            mBlurRadius = keyguardSliceProviderSpark.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            KeyguardSliceProviderSpark keyguardSliceProviderSpark;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProviderSpark = (KeyguardSliceProviderSpark) mProviderReference.get();
            }
            if (keyguardSliceProviderSpark != null) {
                keyguardSliceProviderSpark.notifyChange();
            }
        }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("KeyguardSliceProviderSpark#onBindSlice");
        Slice slice;
