package com.spark.android.systemui.smartspace
...
class KeyguardSmartspaceController @Inject constructor(
    ...
    init {
        if (!featureFlags.isSmartspaceEnabled()) {
            context.packageManager.setComponentEnabledSetting(ComponentName("com.android.systemui", "com.spark.android.systemui.keyguard.KeyguardSliceProviderSpark"), 1, 1)
        } else {
