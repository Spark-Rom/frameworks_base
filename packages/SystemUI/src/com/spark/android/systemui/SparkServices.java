...
@SysUISingleton
public class SparkServices extends VendorServices {
    ...
    @Inject
    public SparkServices(Context context, UiEventLogger uiEventLogger, Lazy<ServiceConfigurationGoogle> serviceConfigurationGoogle, Lazy<ColumbusServiceWrapper> columbusService) {
        super(context);
