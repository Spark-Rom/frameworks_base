...
import static com.spark.android.systemui.Dependency.*;
...
import com.spark.android.systemui.theme.ThemeOverlayControllerSpark;
import com.spark.android.systemui.SparkServices;
import com.spark.android.systemui.assist.AssistManagerGoogle;
...
public abstract class SystemUISparkModule {
    ...
    @Binds
    abstract ThemeOverlayController provideThemeOverlayController(ThemeOverlayControllerSpark themeOverlayController);
