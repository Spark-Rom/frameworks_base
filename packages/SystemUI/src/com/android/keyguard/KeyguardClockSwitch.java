	...
	if (isClockSingleLine) {
        ...
        switch (customClockFont) {
        	...
        	Typeface geometossoftextrabold = Typeface.create("geometossoftextrabold", Typeface.NORMAL);
                setTypeface(geometossoftextrabold);
        	break;
        	default:
        	break;
