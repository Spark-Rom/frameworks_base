...
public class SamsungClockController implements ClockPlugin {
    ...
    private void createViews() {
        ...
        if(SparkUtils.useLockscreenClockMinuteAccentColor(mContext) && SparkUtils.useLockscreenClockHourAccentColor(mContext)) {
        ...
        } else if(SparkUtils.useLockscreenClockHourAccentColor(mContext)) {
        ...
        } else if(SparkUtils.useLockscreenClockMinuteAccentColor(mContext)) {
