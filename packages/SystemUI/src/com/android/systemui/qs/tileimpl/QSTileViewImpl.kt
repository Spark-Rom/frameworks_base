...
open class QSTileViewImpl @JvmOverloads constructor(
    ...
    private fun getBackgroundColorForState(state: Int, disabledByPolicy: Boolean = false): Int {
        return when {
            ...
            state == Tile.STATE_ACTIVE -> if(qsPanelStyle == 3) colorActiveAlpha else colorActive
            state == Tile.STATE_INACTIVE -> if(qsPanelStyle == 3) colorActiveAlpha else colorInactive
            else -> {
    ...
    private fun getLabelColorForState(state: Int, disabledByPolicy: Boolean = false): Int {
        return when {
            ...
            state == Tile.STATE_ACTIVE -> if(qsPanelStyle == 3) colorLabelActiveAccent else colorLabelActive
    ...
    private fun getSecondaryLabelColorForState(state: Int, disabledByPolicy: Boolean = false): Int {
        return when {
            ...
            state == Tile.STATE_ACTIVE -> if(qsPanelStyle == 3) colorSecondaryLabelActiveAccent else colorSecondaryLabelActive
