...
public abstract class AuthBiometricView extends LinearLayout {
    ...
    void onAttachedToWindowInternal() {
        ...
        final CharSequence applockPackage = mPromptInfo.getCharSequence(PromptInfo.KEY_APPLOCK_PKG);
        if (TextUtils.isEmpty(applockPackage)) {
            setText(mTitleView, mPromptInfo.getString(PromptInfo.getTitle()));
            setTextOrHide(mDescriptionView,
                    mPromptInfo.getString(PromptInfo.getDescription()));
        } else {
            ...
            if (icon == null) {
                ...
                setText(mTitleView, getResources().getString(R.string.applock_unlock) + " "
                        + mPromptInfo.getString(PromptInfo.getTitle()));
            } else {
                mTitleView.setVisibility(View.GONE);
                mAppIcon.setVisibility(View.VISIBLE);
                mAppIcon.setImageDrawable(icon);
            }
            setTextOrHide(mDescriptionView, mPromptInfo.getString(PromptInfo.getDescription())
                    + getResources().getString(R.string.applock_locked) + "\n"
                    + credentialButtonText + getResources().getString(getDescriptionTextId()));
